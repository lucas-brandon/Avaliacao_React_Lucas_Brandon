...
import Img1 from '../../main/images/cart.jpg';
          ...
          <div className="card card_border mb-5">
            ...
            <div className="card-body">
              <div className="card-columns">
                ...
                <div className="card">
                  <img src="../../main/images/template2.jpg" className="card-img-top" alt="..."></img>
                  <div className="card-body">
                ...
                <div className="card">
                  <img src="assets/images/dashboard.jpg" className="card-img-top" alt="..."></img>
                </div>
            ...
            <div className="card-body">
              <div className="row row-cols-1 row-cols-md-2">
                <div className="col mb-4">
                  <div className="card">
                    <img src="assets/images/template2.jpg" className="card-img-top" alt="..."></img>
                    <div className="card-body">
                      <h5 className="card-title">Card title</h5>
                ...
                <div className="col mb-4">
                  <div className="card">
                    <img src="assets/images/desk.jpg" className="card-img-top" alt="..."></img>
                    <div className="card-body">
                      <h5 className="card-title">Card title</h5>
                      <p className="card-text">This is a longer card with supporting text below as a natural lead-in to
                        additional
                ...
                <div className="col mb-4">
                  <div className="card">
                    <img src="assets/images/cart.jpg" className="card-img-top" alt="..."></img>
                    <div className="card-body">
                      <h5 className="card-title">Card title</h5>
                      <p className="card-text">This is a longer card with supporting text below as a natural lead-in to
                        additional
