          ...
          <div className="card-body py-3 p-0">
            <div className="row">
              ...
              <div className="col-lg-6 pl-lg-4 mt-lg-0 mt-4">
                <img src="assets/images/template2.jpg" alt="" className="img-fluid rounded"></img>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="card-body py-3 p-0">
            <div className="row">
              <div className="col-lg-6 pr-lg-4">
                <img src="assets/images/template1.jpg" alt="" className="img-fluid rounded"></img>
              </div>
          ...
          <div className="card-body py-3 p-0">
            ...
            <div className="row cwp23-content">
              ...
              <div className="col-md-6 mt-md-0 mt-5 cwp23-img">
                <img src="assets/images/template2.jpg" className="img-fluid rounded" alt=""></img>
              </div>
            </div>
          </div>
        </div>
